...
def compareSQLResult(sql_path):
        ...
        middleware = pymysql.connect(host=middleware_host,user=middleware_user,password=middleware_password,port=middleware_port)
        cur = db.cursor()
                                        ...
                                        try:
                                                ...
                                                if sql[1] == '1':
                                                        ...
                                                        try:
                                                                ...
                                                                logging.error("Sorted result set is not same in number %d column!" % index)
                                                                return 0
                                                else:
                                                        continue
